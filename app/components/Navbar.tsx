        ...
        >
          ...
          <nav className="flex items-center justify-between mx-auto w-full max-w-screen-xl px-5 md:px-8 h-[72px] shrink-0">
            ...
            <div className="flex items-center gap-6">
              ...
              <Link
                href="/contact"
                className="hidden md:inline-flex items-center gap-2 bg-crimson text-white text-sm font-medium px-5 py-2.5 rounded-full hover:bg-crimson/90 transition-colors duration-200"
                onClick={() => setIsOpen(false)}
              >
                Get in Touch
              </Link>
            ...
            {isOpen && (
              ...
              >
                ...
                <Link
                  href="/contact"
                  onClick={() => setIsOpen(false)}
                  className="bg-crimson text-white text-center text-base font-medium px-8 py-4 rounded-full hover:bg-crimson/90 transition-colors duration-200 mt-auto"
                >
                  Get in Touch
                </Link>
              </motion.div>
