      ...
      <footer className="border-t border-zinc-800 py-12 md:py-16">
        <div className="max-w-screen-xl mx-auto px-5 md:px-8">
            ...
            <div>
              ...
              <div className="flex flex-col gap-2.5">
                {['Home', 'About', 'Projects', 'Contact'].map(page => (
                  <Link key={page} href={page === 'Home' ? '/' : page === 'Projects' ? '/services' : `/${page.toLowerCase()}`} className="text-zinc-400 text-sm hover:text-white transition-colors">
                    {page}
                  </Link>
                ))}
              </div>
          ...
          <div className="mt-12 pt-8 border-t border-zinc-800 flex flex-col md:flex-row items-center justify-between gap-4">
            <span className="text-zinc-500 text-xs">© 2026 Medici Social. All rights reserved.</span>
